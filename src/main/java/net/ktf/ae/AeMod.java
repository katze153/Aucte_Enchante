...
import net.ktf.ae.init.AeModTabs;
...
import net.ktf.ae.init.AeModBlocks;
import net.ktf.ae.init.AeModBlockEntities;
...
@Mod("ae")
public class AeMod {
	public static final Logger LOGGER = LogManager.getLogger(AeMod.class);
	...
	public AeMod() {
		...
		AeModBlocks.REGISTRY.register(bus);
		AeModBlockEntities.REGISTRY.register(bus);
		AeModItems.REGISTRY.register(bus);
		AeModEntities.REGISTRY.register(bus);

		AeModTabs.REGISTRY.register(bus);

		AeModParticleTypes.REGISTRY.register(bus);

		AeModMenus.REGISTRY.register(bus);
						...
						for (Field field : fields) {
							if (EditBox.class.isAssignableFrom(field.getType())) {
								try {
									...
									AeMod.LOGGER.error(exceptionAsString);
								}
							}
						}
					}
	...
	public static class initer {
		...
		public static void init(FMLCommonSetupEvent event) {
			AeMod.addNetworkMessage(TextboxSetMessage.class, TextboxSetMessage::buffer, TextboxSetMessage::new, TextboxSetMessage::handler);
		}
	}
