...
public class GTEScreen extends AbstractContainerScreen<GTEMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("ae:textures/screens/gte.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("ae:textures/screens/pluss.png"), this.leftPos + 74, this.topPos + 18, 0, 0, 16, 16, 16, 16);
