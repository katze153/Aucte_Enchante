...
import net.ktf.ae.procedures.UmainnProcedure;
...
public class GTESlotMessage {
	...
	public GTESlotMessage(int slotID, int x, int y, int z, int changeType, int meta, HashMap<String, String> textstate) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public static void handleSlotAction(Player entity, int slot, int changeType, int meta, int x, int y, int z, HashMap<String, String> textstate) {
		...
		if (slot == 0 && changeType == 0) {
			...
			UmainnProcedure.execute(world, entity);
		}
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		AeMod.addNetworkMessage(GTESlotMessage.class, GTESlotMessage::buffer, GTESlotMessage::new, GTESlotMessage::handler);
	}
